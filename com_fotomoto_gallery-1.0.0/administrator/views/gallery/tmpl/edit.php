...
$document->addStyleSheet(Uri::root() . 'media/com_fotomoto_gallery/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_fotomoto_gallery&layout=edit&id=' . (int) $this->item->id); ?>"
